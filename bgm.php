...
<body id="target">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<input type="button" onclick="myFunction1()" value="01. blossom" class="btn btn-default btn-lg">
				<input type="button" onclick="myFunction2()" value="02. dancin'" class="btn btn-default btn-lg">
				<input type="button" onclick="myFunction3()" value="03. Plans" class="btn btn-default btn-lg">
				<input type="button" onclick="myFunction4()" value="04. Lost Piano" class="btn btn-default btn-lg">
			<p id="bgm_arti"></p>
