		...
		<div class="row">
			...
			<div class="col-md-9">
				<article>
					<form action="process.php" method="post">
						...
						<div class="form-group">
								...
								<textarea rows="10" class="form-control" name="description" id="form-description" placeholder="내용을 입력하세요."></textarea>
						</div>
				...
				<div id="control">
					...
					<a href="/search.php" class="btn btn-default btn-lg" />search</a>
